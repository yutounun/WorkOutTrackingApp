...
<template>
  <div class="h-32 ml-4">
    ...
    <div class="flex items-center mt-6 mx-5">
      ...
      <p class="text-2xl mx-10">→</p>
      <div class="text-center">
        <h2 class="block text-lg">Lose Fat</h2>
